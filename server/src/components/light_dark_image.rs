...
pub fn light_dark_image_with_lqip<'a>(
    ...
    html! {
        div
            ...
            picture
                class="shrink-0 w-full min-h-full object-cover blur-lg" {
               ...
               img
                    ...
                    class="shrink-0 w-full min-h-full object-cover"
...
pub fn light_dark_image_with_color_placeholder<'a>(
    ...
    html! {
        div
            class={"light-dark-image-with-color-placeholder select-none relative " (class)} {
